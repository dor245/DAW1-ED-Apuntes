...
LA CPU SE LLAMA TAMBIEN UCP, PROCESADOR O MICROPROCESADOR
...
Solo válido para lenguajes complicados : C C++

En lenguajes interpretados no existe codigo objeto, ni binario. Solo código fuente.
